    ...
    return (
        ...
        <div className='vh-100 justify-content-center align-items-center'>
            <div className='bg-white p-3'>   
                ...
                {paramPath === "SWList" && <>
                    <Link to="/addsw2" className='btn btn-primary'>Add SW Data</Link>&nbsp;
                    <Link to="/switch-excel2" className='btn btn-success'>Import Excel Data (Beta)</Link>&nbsp;
                </>}
                ...
                <table className="table table-bordered">
                    ...
                    {swlist.map ((swlist,index) => (                       
                        <tr key={index}>
                            ...
                            <td><Link to={`/report_sw2/${swlist.ID}`} className="btn btn-dark">Click</Link></td>
                        </tr>                   
                        ))}
                     </tbody>    
                 </table>
